...
import { BookOpen, Calendar, Users, Video, Award, Settings } from "lucide-react";

export const TutorDashboard = () => {
  const upcomingSessions = [
    { id: 1, student: "John Kamau", subject: "Mathematics", time: "2:00 PM", type: "1-on-1" },
    { id: 2, student: "Sarah Oduya", subject: "Physics", time: "4:00 PM", type: "Group" },
    { id: 3, student: "Ahmed Hassan", subject: "Chemistry", time: "6:00 PM", type: "1-on-1" }
  ];

  const courses = [
    { id: 1, title: "KCSE Mathematics", students: 45, rating: 4.8, earnings: 15000 },
    { id: 2, title: "Physics Fundamentals", students: 32, rating: 4.9, earnings: 12000 },
    { id: 3, title: "Advanced Chemistry", students: 28, rating: 4.7, earnings: 10500 }
  ];
